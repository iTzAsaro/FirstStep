...
export type UpsertCompanyProfileInput = Partial<Pick<CompanyProfile, "companyName" | "industry" | "website" | "description">>;
  ...
  async upsert(userId: number, input: UpsertCompanyProfileInput) {
    ...
    await this.db.execute(
      `INSERT INTO company_profiles
        (user_id, company_name, industry, website, description, created_at, updated_at)
       VALUES
        (:userId, :companyName, :industry, :website, :description, NOW(), NOW())
